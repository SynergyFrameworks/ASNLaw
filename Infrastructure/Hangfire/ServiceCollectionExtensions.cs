...
namespace Hangfire
{
    public static class ServiceCollectionExtensions
    {
        ...
        {
            var section = configuration.GetSection("ScionAnalytics:Hangfire");
            ...
            if (hangfireOptions.JobStorageType == HangfireJobStorageType.SqlServer)
            {
                ...
                .UseSqlServerStorage(configuration.GetConnectionString("ScionAnalytics"), hangfireOptions.SqlServerStorageOptions));
            }
            else
            {
