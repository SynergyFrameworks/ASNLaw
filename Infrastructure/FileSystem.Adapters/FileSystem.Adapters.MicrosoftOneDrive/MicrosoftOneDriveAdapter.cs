...
namespace StorageProvider.Adapters.MicrosoftOneDrive
{
    public class GoogleDriveAdapter : Adapter
    {
        ...
        public GoogleDriveAdapter(string prefix, string rootPath, GraphServiceClient client, string driveId) : base(prefix, rootPath)
        {
            this.client = client;
