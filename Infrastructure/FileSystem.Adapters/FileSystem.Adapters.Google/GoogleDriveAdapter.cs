...
//using DirectoryNotFoundException = FileSystem.Exceptions.DirectoryNotFoundException;
//using FileNotFoundException = FileSystem.Exceptions.FileNotFoundException;

//namespace FileSystem.Adapters.GoogleDrive
//{
//    public class GoogleDriveAdapter : Adapter
//    {
//        private readonly GoogleDriveFile client;
//        private readonly string driveId;

//        public GoogleDriveAdapter(string prefix, string rootPath, GoogleDriveFile client, string driveId) : base(prefix, rootPath)
//        {
//            this.client = client;
