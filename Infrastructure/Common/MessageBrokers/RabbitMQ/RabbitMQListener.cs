...
namespace Infrastructure.Common.MessageBrokers.RabbitMQ
{
    public class RabbitMQListener : IEventListener
    {
        ...
        public RabbitMQListener(
            IBus busClient,
            IOptions<RabbitMQBusOptions> options,
        ...
        public virtual void Subscribe(Type type)
        {
            ...
            //        .FromDeclaredQueue(q => q.WithName((_options.GetQueue().Name ?? AppDomain.CurrentDomain.FriendlyName).Trim().Trim('_') + "_" + type.Name)))
            //);
        }
        ...
        //{
        //    return e => e
        //        .WithName(_options.GetExchange().Name)
