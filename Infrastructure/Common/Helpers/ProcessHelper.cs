...
using System.Linq;
using System.Text;
using Infrastructure.ProcessSettings;

namespace Infrastructure.Common.Persistence.Helpers
{
    public static class ProcessHelper
    {
        public static Process StartProcess(ProcessSettings.ProcessSettings toolSettings) => StartProcessInternal(toolSettings.GetFullPathTool(),
