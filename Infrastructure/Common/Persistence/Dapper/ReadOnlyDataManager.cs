...
using Infrastructure.Common.Persistence.Dapper.TypeHandlers;
...
namespace Infrastructure.Common.Persistence.Dapper
{
    public class ReadOnlyDataManager : IReadOnlyDataManager
    {
        ...
        public ICriteriaHandler CInterceptor { get; set; }
        private event EventHandler<QueryInfo> QueryInfoInterceptor;
        public IQueryInfoHandler QInterceptor { get; set; }
        ...
        public DynamicResultSet DynamicFindAll<T>(Criteria criteria = null)
        {
            ...
            set.Metadata = (IList<Mapping.HeaderMetadata>)GenerateMetadata(criteria, GetRowWithValues(set.Data));
