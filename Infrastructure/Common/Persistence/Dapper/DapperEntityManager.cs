...
namespace Infrastructure.Common.Persistence.Dapper
{
    public class DapperEntityManager : IDapperEntityManager
    {
        ...
        //    QueryColumnMapping(obj, /*out string inactiveColumn, out string inactiveParam,*/ out string modifiedByColumn, out string modifiedcreatedByParam, out string modifiedDateByColumn, out string modifiedDateByParam, out string createdByColumn, out string createdByParam, out string createdDateByColumn, out string createdDateByParam, out string tenantByColumn, out string tenantByParam);
        ...
        //   // inactiveColumn = ColumnBind("INACTIVE_INDICATOR", checkPropertyAndMapColumn(obj, "IsInactive") && !isAuditLogTable());
        //   // inactiveParam = ColumnPrefixBind("IsInactive", checkPropertyAndMapColumn(obj, "IsInactive") && !isAuditLogTable());
