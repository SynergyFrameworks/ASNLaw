...
using Infrastructure.Common.Persistence.OneDrive.Entities;
using Infrastructure.Common.Persistence.OneDrive.Helpers;
...
namespace Infrastructure.Common.Persistence.OneDrive
{
    class OneDriveConsumer : OneDrive
    {
        ...
        public OneDriveConsumer(string clientId, string clientSecret) : base(clientId, clientSecret)
        {
        ...
        public static async Task<OneDrive> GetOneDriveApiFromRefreshToken(string clientId, string clientSecret, string refreshToken)
        {
            var oneDriveApi = new OneDriveConsumer(clientId, clientSecret);
