...
//using Infrastructure.Common.Persistence.Azure.ErrorHandlers;
...
//            table.Execute(TableOperation.Delete(temp));
//        }
...
//            table.Execute(TableOperation.InsertOrMerge(transformer.TransformToAzureObject(obj)));
