...
namespace Security.Common.Authorization
{
    public abstract class PermissionAuthorizationHandlerBase<TRequirement> : AuthorizationHandler<TRequirement> where TRequirement : PermissionAuthorizationRequirement
    {
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, TRequirement requirement)
        {
            ...
            // This can help to authorize the user for direct(non - AJAX) GET requests to the Scion Analytics platform API and / or to use some 3rd - party web applications for the Scion Analytics platform(like Hangfire dashboard).
            //
