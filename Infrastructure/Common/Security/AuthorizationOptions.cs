...
namespace Infrastructure.Security
{
    public class AuthorizationOptions
    {
        ...
        // This can help to authorize the user for direct(non - AJAX) GET requests to the ASNAnalytics platform API and / or to use some 3rd - party web applications for the ASN Analytics platform(like Hangfire dashboard).
        //
