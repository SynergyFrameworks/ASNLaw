    ...
    public static class ObjectExtensions
    {
        ...
        private static string ComputeHash<T>(object instance, T cryptoServiceProvider) where T : HashAlgorithm, new()
        {
            ...
            using (StringWriter textWriter = new StringWriter())
            {
                ...
                // Ensure the string is being encoded and hash is computed
                byte[] dataToHash = System.Text.Encoding.UTF8.GetBytes(textWriter.ToString());
                cryptoServiceProvider.ComputeHash(dataToHash);

                // Convert the hash to base64 string
                return System.Convert.ToBase64String(cryptoServiceProvider.Hash);
            }
        }
        ...
        public static Nullable<T> ToNullable<T>(this object obj) where T : struct
        {
            ...
            return (T)System.Convert.ChangeType(obj, objType);
        }
