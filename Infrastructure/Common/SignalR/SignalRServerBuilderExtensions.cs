...
namespace Infrastructure.SignalR
{
    public static class SignalRServerBuilderExtensions
    {
        ...
        public static void AddRedisBackplane(this ISignalRServerBuilder builder, IConfiguration configuration)
        {
            ...
            {
                builder.AddStackExchangeRedis(redisConnectionString, options => options.Configuration.ChannelPrefix = configuration["SignalR:RedisBackplane:ChannelName"] ?? "ScionAnalyticsChannel");
            }
        }
    }
}
