...
namespace Excel.EPPlus
{
    public class EPPlusWorksheet : IWorksheet
    {
        ...
        public IDrawings Drawings => throw new NotImplementedException();
        ...
        public IList<KeyValuePair<string, ExcelRangeBase>> FindWithValue(string value)
        {
            if (_worksheet.Dimension == null)
                return new List<KeyValuePair<string, ExcelRangeBase>>();
            return
                (from cell in
                     _worksheet.Cells[
                 ...
                 select new KeyValuePair<string, ExcelRangeBase>(cell.FullAddress, cell)).ToList();
