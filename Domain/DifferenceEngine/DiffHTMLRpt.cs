...
namespace Domain.DiffSxS
{
    public class DiffHTMLRpt
    {
        ...
        //    DomainRTFf2HTMLf.Convert convert = new DomainRTFf2HTMLf.Convert();
        ...
        public void End_8()
        {
            ...
            _writer.WriteLine(string.Concat(TAB, TAB, TAB, TAB, TAB, "This report was generated by Document Analyzer's Diff SxS, Copyright ", dt.Year.ToString(), " by Domain, LLC"));
