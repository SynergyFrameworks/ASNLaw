...
namespace Scion.Business.Security.Migrations
{
    ...
    [Migration("20000000000000_UpdateSecurityV2")]
    partial class UpdateSecurityV2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Scion.Business.Core.Security.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("MemberId").HasMaxLength(128);
                    ...
                    b.Property<string>("StoreId").HasMaxLength(128);
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("Scion.Business.Core.Security.Role")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Scion.Business.Core.Security.ApplicationUser")
                        .WithMany()
