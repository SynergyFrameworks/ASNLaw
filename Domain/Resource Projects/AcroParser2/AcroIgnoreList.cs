...
{
    public class AcroIgnoreList
    {
        public AcroIgnoreList(string LibsPath)
        {
            _LibsPath = LibsPath;
        }

        private string _LibsPath = string.Empty;
        ...
        {
            DataTable table = new DataTable("IgnLib");
        ...
        public DataSet GetDataset(string IgnLibName)
        {
            _PathFile = string.Concat(_LibsPath, @"\", IgnLibName, ".xml");
