...
namespace Atebion.CovertDoctoRTF
{
	/// <summary>
	...
	public class csCovertDoctoRTF
	{
		...
		public bool CovertDoc(wdFormats wdFormat, string sFromFile, string sToFile )
		{
            ...
            try
            {
                WordPdfImportWarningRemover wordpdf = new WordPdfImportWarningRemover();
            }
            catch (Exception e)
            {
            ...
            // Test -- CovertDoc3 has problems (bugs)
            //return CovertDoc3(wdFormat, sFromFile, sToFile);
            //
