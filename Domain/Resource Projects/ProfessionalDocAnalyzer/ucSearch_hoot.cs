...
{
    public partial class ucSearch_hoot : UserControl
    {
        public ucSearch_hoot()
        {
        ...
        private void ChkRunIndexer()
        {
            ...
            DateTime dtIndex = Files.GetLatestFileDatetime(_IndexPath);
            DateTime dtParsedFiles = Files.GetLatestFileDatetime(_FilesPath);
        ...
        public void RunIndexer()
        {
            ...
            string[] files = Directory.GetFiles(_FilesPath, "*", SearchOption.TopDirectoryOnly);
