...
// 08-26-2014 http://blogs.artinsoft.net/mrojas/archive/2009/07/10/printing-richtextbox-contents-in-c.aspx
// 08-29-2014: Added Preview Method to Extension
// 09-02-2014: Added PageSettings and PrinterSettings properties to Extension
// 09-04-2014: Added Exception Handling by reference
// 09-28-2016: Fixed StartPosition so preview dialog is centered
//             Added Header Support
// Call with : source Rich Text Box, Page Settings, Printer Settings and an Exception object by reference
//             Exception will be null unless an exception occurs
...
namespace ProfessionalDocAnalyzer
{
    ...
    {
        public static void Print(this RichTextBox control, PageSettings page, PrinterSettings printer, ref Exception HelperException)
        {
    ...
    {
        RichTextBox control;
        int PageNumber = 0; // counter for Header  09-21-2016
        public static Font headerfont = new Font("Arial", 12);
        public static bool pagenumberson = false;
        public static bool headeron = false;
        public static string headerstring = string.Empty;
        ...
        public void PreviewRTF(PrintDocument printDocument)
        {
            try
            {
                ...
                ppd.StartPosition = (System.Windows.Forms.FormStartPosition.CenterParent);
        ...
        private void printDocument_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            // ADDED HEADER SUPPORT 09-23-2016
            // ref http://stackoverflow.com/questions/59213/easiest-way-to-add-a-header-and-footer-to-a-printing-printdocument-net-2-0

            PageNumber++;
            if (headeron && pagenumberson)
            {
                e.Graphics.DrawString(headerstring + "  Page - " + PageNumber.ToString(), headerfont, Brushes.Black, 95, 70);
            }
            else
            {
                if (headeron)
                {
                    e.Graphics.DrawString(headerstring, headerfont, Brushes.Black, 95, 70);
                }
            }
