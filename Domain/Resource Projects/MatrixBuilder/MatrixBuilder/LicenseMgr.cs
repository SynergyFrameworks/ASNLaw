...
namespace MatrixBuilder
{
    class LicenseMgr
    {
        ...
        private string _licFile = string.Concat(AppFolders.AppDataPath, @"\", "ProfDocAnalyzer.lic");
        ...
        private Habanero.Licensing.Validation.LicenseValidator Validator
        {
            get
            {
                ...
                return new Habanero.Licensing.Validation.LicenseValidator(Habanero.Licensing.Validation.LicenseLocation.File, string.Concat(AppFolders.AppDataPath, @"\", "ProfDocAnalyzer.lic"), "ProfDocAnalyzer", publicKey, applicationSecret, ThisVersion);
