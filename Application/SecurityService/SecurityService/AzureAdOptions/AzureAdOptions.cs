namespace Scion.Infrastructure.Web.Azure
{
    public class AzureAdOptions
    {
        ...
        /// <summary>
        /// Application ID of the ScionAnalytics platform application registered in Azure Active Directory. It can be found 
