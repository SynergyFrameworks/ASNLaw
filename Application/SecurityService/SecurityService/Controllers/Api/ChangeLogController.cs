...
using Scion.Infrastructure.Web.Model;
using System;
using System.Linq;
...
namespace Scion.Infrastructure.Web.Controllers.Api
{
    ...
    public class ChangeLogController : Controller
    {
        ...
        {
            LastModifiedResponse result = new LastModifiedResponse
            {
                Scope = scope,
        ...
        {
            ChangedEntitiesResponse result = new ChangedEntitiesResponse()
            {
        ...
        public async Task<ActionResult<ChangeLogSearchResult>> SearchChanges([FromBody] ChangeLogSearchCriteria criteria)
        {
            ...
            ChangeLogSearchResult result = await _changeLogSearchService.SearchAsync(criteria);
        ...
        {
            ChangeLogSearchCriteria criteria = new ChangeLogSearchCriteria
            {
                ObjectType = type,
                StartDate = start,
                EndDate = end
