...
namespace Scion.Infrastructure.Web.Controllers.Api
{
    ...
    public class DynamicPropertiesController : Controller
    {
        ...
        {
            DynamicPropertySearchResult result = await _dynamicPropertySearchService.SearchDynamicPropertiesAsync(criteria);
            return Ok(result);
        }
        ...
        {
            DynamicProperty[] result = await _dynamicPropertyService.SaveDynamicPropertiesAsync(new[] { property });
        ...
        {
            DynamicPropertyDictionaryItemSearchResult result = await _dynamicPropertyDictionaryItemsSearchService.SearchDictionaryItemsAsync(criteria);
            return Ok(result);
        }
        ...
        {
            DynamicPropertySearchResult result = await _dynamicPropertySearchService.SearchDynamicPropertiesAsync(new DynamicPropertySearchCriteria { ObjectType = typeName });
        ...
        {
            DynamicPropertyDictionaryItemSearchResult result = await _dynamicPropertyDictionaryItemsSearchService.SearchDictionaryItemsAsync(new DynamicPropertyDictionaryItemSearchCriteria { PropertyId = propertyId, ObjectType = typeName });
            return Ok(result.Results);
        }
        ...
        {
            foreach (DynamicPropertyDictionaryItem item in items)
            {
