        ...
        public async Task<ActionResult> Exchange(OpenIdConnectRequest openIdConnectRequest)
        {
            ...
            if (openIdConnectRequest.IsPasswordGrantType())
            {
                ...
                if (limitedPermissions.Any())
                {
                    ...
                    // This can help to authorize the user for direct(non - AJAX) GET requests to the PFA platform API and / or to use some 3rd - party web applications for the PFA platform(like Hangfire dashboard).
                    //
